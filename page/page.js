...
//キービジュアル
Vue.component('key-visual',{
	template:
	`
	<div class="jumbotron kv home-kv">
	 	<router-view class="kv" name="kv"></router-view>
	 ...
	 viewBox="0 0 1820 1080" xml:space="preserve">
			<g id="home">
				<defs>
					<rect id="masque" y="0.4" min-height="150px" width="1820" height="1080"/>
				</defs>
				<clipPath id="cache">
					<use xlink:href="#masque"  style="overflow:hidden;"/>
				</clipPath>
				<g id="light-blue">
